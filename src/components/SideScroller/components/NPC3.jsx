...
const NPC3 = ({ x, y, size, onInteract, playerX, playerName }) => {
    const SPEECH_TEXT = `Hey ${playerName || "explorer"}, got a minute?`;
    ...
    const imagePath = `/images/NPC3/idle/frame${frame}.png`;
